...
model.outgoing_longwave(olr_type='full_radiation_no_lr', A=None, B=None, emissivity=None, RH_vert_profile='steps', RH_lat_profile='mid_level_gaussian', gaussian_spread=5)
