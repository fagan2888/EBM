...
model = EnergyBalanceModel(N_pts=401, dtmax_multiple=50.0, max_sim_years=5.0, tol=1e-10)
...
model.outgoing_longwave(olr_type='full_wvf', A=300.0, B=0.0, emissivity=0.6, RH_vert_profile='steps', RH_lat_profile='mid_level_gaussian', gaussian_spread=5, constant_spec_hum=False)
