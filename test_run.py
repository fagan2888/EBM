...
# model = EnergyBalanceModel(N_pts=401, dtmax_multiple=5.0, max_sim_years=5.0, tol=1e-10)
...
model.outgoing_longwave(olr_type='full_wvf', A=-281.67, B=1.8, emissivity=0.6, RH_vert_profile='steps', RH_lat_profile='mid_level_gaussian', gaussian_spread=5, constant_spec_hum=False)
