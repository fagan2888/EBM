...
# model = EnergyBalanceModel(N_pts=401, dtmax_multiple=5e2, max_sim_years=5.0, tol=1e-8)
model = EnergyBalanceModel(N_pts=401, dtmax_multiple=1e3, max_sim_years=5.0, tol=1e-8)
# model = EnergyBalanceModel(N_pts=401, dtmax_multiple=1e4, max_sim_years=5.0, tol=1e-8)
