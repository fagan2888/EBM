...
class DEBM:
    ...
    def __init__(self):
        self.albedo_feedback = False

    def set_insolation(self, insolation_type, M=0, sigma=0, lat0=0):
        if insolation_type == 'annual_mean':
            ...
            # From Clark: M = 5, 10, 15, 18; lat0 = 15, 60; sigma = 4.94, 9.89
    ...
    def set_albedo_feedback(self, bool_val):
        self.albedo_feedback = bool_val
    
    
    ################################################################################
    # ALBEDO
    ################################################################################
    if self.albedo_feedback == True:
        a1 = 0.8
        a2 = 0.1 
        init_alb = 0*lats + a2
