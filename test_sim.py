...
model.outgoing_longwave(olr_type='planck', A=-450, B=2.5, emissivity=0.6, RH_vert_profile=None, RH_lat_profile=None, 
        gaussian_spread1=None, gaussian_spread2=None, scale_efe=None)

model.solve(numerical_method='euler_for', nPlot=100, nPrint=500)
